...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResourceTfProviderConfiguration();
  });
  ...
  describe('ResourceTfProviderConfiguration', function() {
    it('should create an instance of ResourceTfProviderConfiguration', function() {
      // uncomment below and update the code to test ResourceTfProviderConfiguration
      //var instane = new Lunaform.ResourceTfProviderConfiguration();
      //expect(instance).to.be.a(Lunaform.ResourceTfProviderConfiguration);
    });
