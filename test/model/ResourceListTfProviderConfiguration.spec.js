...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResourceListTfProviderConfiguration();
  });
  ...
  describe('ResourceListTfProviderConfiguration', function() {
    it('should create an instance of ResourceListTfProviderConfiguration', function() {
      // uncomment below and update the code to test ResourceListTfProviderConfiguration
      //var instane = new Lunaform.ResourceListTfProviderConfiguration();
      //expect(instance).to.be.a(Lunaform.ResourceListTfProviderConfiguration);
    });
