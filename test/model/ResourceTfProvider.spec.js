...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResourceTfProvider();
  });
  ...
  describe('ResourceTfProvider', function() {
    it('should create an instance of ResourceTfProvider', function() {
      // uncomment below and update the code to test ResourceTfProvider
      //var instane = new Lunaform.ResourceTfProvider();
      //expect(instance).to.be.a(Lunaform.ResourceTfProvider);
    });
