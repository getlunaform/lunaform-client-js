...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResourceListTfProvider();
  });
  ...
  describe('ResourceListTfProvider', function() {
    it('should create an instance of ResourceListTfProvider', function() {
      // uncomment below and update the code to test ResourceListTfProvider
      //var instane = new Lunaform.ResourceListTfProvider();
      //expect(instance).to.be.a(Lunaform.ResourceListTfProvider);
    });
