...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResourcetfproviderconfigurationEmbedded();
  });
  ...
  describe('ResourcetfproviderconfigurationEmbedded', function() {
    it('should create an instance of ResourcetfproviderconfigurationEmbedded', function() {
      // uncomment below and update the code to test ResourcetfproviderconfigurationEmbedded
      //var instane = new Lunaform.ResourcetfproviderconfigurationEmbedded();
      //expect(instance).to.be.a(Lunaform.ResourcetfproviderconfigurationEmbedded);
    });
