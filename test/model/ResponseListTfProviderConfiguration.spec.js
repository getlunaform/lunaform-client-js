...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResponseListTfProviderConfiguration();
  });
  ...
  describe('ResponseListTfProviderConfiguration', function() {
    it('should create an instance of ResponseListTfProviderConfiguration', function() {
      // uncomment below and update the code to test ResponseListTfProviderConfiguration
      //var instane = new Lunaform.ResponseListTfProviderConfiguration();
      //expect(instance).to.be.a(Lunaform.ResponseListTfProviderConfiguration);
    });
