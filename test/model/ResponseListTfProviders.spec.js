...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.ResponseListTfProviders();
  });
  ...
  describe('ResponseListTfProviders', function() {
    it('should create an instance of ResponseListTfProviders', function() {
      // uncomment below and update the code to test ResponseListTfProviders
      //var instane = new Lunaform.ResponseListTfProviders();
      //expect(instance).to.be.a(Lunaform.ResponseListTfProviders);
    });
