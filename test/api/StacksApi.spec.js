...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Lunaform.StacksApi();
  });
  ...
  describe('StacksApi', function() {
    describe('deployStack', function() {
      it('should call deployStack successfully', function(done) {
        //uncomment below and update the code to test deployStack
        //instance.deployStack(function(error) {
    ...
    describe('getStack', function() {
      it('should call getStack successfully', function(done) {
        //uncomment below and update the code to test getStack
        //instance.getStack(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
